...
def process_silver_usda(df):
    """Clean USDA: standardize, enforce types, round. Extract weight if available."""
    ...
    if 'serving_size' in df.columns and 'serving_size_unit' in df.columns:
        ...
        # Where unit is g or ml, use serving size directly
        ...
        # Where unit is oz or fl oz, multiply by 28.35
